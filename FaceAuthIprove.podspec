...
Pod::Spec.new do |s|
  s.name             = 'FaceAuthIprove'
  s.version          = '1.0.1'
  s.summary          = 'FaceAuthIprove'
  s.homepage         = 'https://github.com/combateafraude/iOS'
  s.license          = { :type => 'MIT', :file => 'FaceAuthIprove/LICENSE' }
  ...
  s.ios.vendored_frameworks = 'FaceAuthIprove/FaceAuthIprove.xcframework'
