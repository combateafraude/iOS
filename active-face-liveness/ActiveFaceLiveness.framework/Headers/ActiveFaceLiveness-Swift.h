...
#ifndef ACTIVEFACELIVENESS_SWIFT_H
#define ACTIVEFACELIVENESS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ActiveFaceLiveness",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// The <code>CFFaceLivenessController</code> class is meant to be presented. It consists of a series of 3 different screens which guide the user:
/// <ol>
///   <li>
...
///   </li>
/// </ol>
SWIFT_CLASS("_TtC18ActiveFaceLiveness28ActiveFaceLivenessController")
@interface ActiveFaceLivenessController : UINavigationController
