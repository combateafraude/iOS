...
Pod::Spec.new do |s|
  s.name             = 'DocumentDetectorNoSentryStatic'
  s.version          = '4.4.0'
  s.summary          = 'DocumentDetectorNoSentryStatic'
  s.homepage         = 'https://github.com/combateafraude/iOS'
  s.license          = { :type => 'MIT', :file => 'document-detector-nosentry-static/LICENSE' }
  ...
  s.ios.vendored_frameworks = 'document-detector-nosentry-static/DocumentDetector.framework'
